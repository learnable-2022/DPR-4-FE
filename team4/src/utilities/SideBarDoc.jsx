  ...
  return (
    <div className="sideBar">
       ...
       <div className='mid-section'>
                      <Link  to="/DocDashboard" className='link'><RxDashboard /><p>Dashboard</p></Link>
                    
                    <Link to="/DocBillings" className='link'><FontAwesomeIcon icon={faCoins} /><p>Billings</p></Link>
                    <Link to="/DocDraft"className='link'><TfiWrite/><p>Draft</p></Link>
                   </div>
                 <div className='lower-section'>
                 <Link to="/Docsettings"className='link'><AiOutlineSetting/><p>settings</p></Link>
                <Link to ="/DocLogout"className='link'><FiLogOut/><p>logout</p></Link>
                 </div>
    </div>
  )
}
