    ...
    {/* <div>
     ...
     <div className="sign-up-container">
        <div className="signup-form length">
            ...
            <h2>Get Started</h2>
            <p>Creating an account is very easy, your privacy is our priority.
            <br/>Please select a category</p>
          <div className='confirmation-buttons'>
            <button className='con-button-1' type='button'  onClick={toDoctor}>Doctor</button>
            <button className='con-button-2' type='button' onClick={toPatient}>Patient</button>
          </div>
